...
class CucumberReporter {
    ...
    handleBeforeFeatureEvent (feature, callback) {
    ...
    handleBeforeScenarioEvent (scenario, callback) {
    ...
    handleBeforeStepEvent (step, callback) {
        this.testStart = new Date()
    ...
    handleStepResultEvent (stepResult, callback) {
    ...
    handleAfterScenarioEvent (scenario, callback) {
        this.emit('suite:end', {
            title: scenario.getName(),
            parent: this.runningFeature.getName(),
            type: 'suite',
    ...
    handleAfterFeatureEvent (feature, callback) {
        this.emit('suite:end', {
            title: feature.getName(),
            type: 'suite',
            file: this.getUriOf(feature),
